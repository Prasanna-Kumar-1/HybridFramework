package com.qa.Utilities;
	...
	//which would be displayed/logged as the AUT is being run.
	//All these methods will be invoked automatically as an when any action is done (click, findBy etc). 
	//We get proper Error Console Logs & What's happening during the Execution.

	//Important:
	//Always Create Reference Variable in Class Level as shown below so that it can be used in other classes
